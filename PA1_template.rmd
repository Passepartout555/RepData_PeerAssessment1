---
title: "Coursera Course Reproducible Research - Week 2 Assignment"
author: "Wener Steinbeck"
...
**Code**
```{r Calculate mean number of steps, echo=TRUE} 
...
The mean total number of steps taken per day is `r MeanStepsPerDay`. The median total number of steps taken per day is `r MedianStepsPerDay`.
...
The number of missing values in the original data set is **`r  NumberofNAs`**.
...
```{r Calculate the mean again, echo=TRUE} 
...
#### Report on the Data
The mean total number of steps taken per day is `r MeanStepsPerDay2`. The median total number of steps taken per day is `r MedianStepsPerDay2`.
...
**Answer:** Difference in the mean is `r MeanStepsPerDay2 - MeanStepsPerDay`, difference in the median is `r MedianStepsPerDay2 - MedianStepsPerDay`.
...
```{r Add factor variable for weekend or not, echo=TRUE} 
...
```{r Panel plot Steps on weekend vs. weekdays, echo=TRUE}
